...
class IOSPHPMailer {
   ...
   * @return bool
   */
  public function SetLanguage($lang_type = 'en', $lang_path = '') {
  ...
  public function CreateHeader() {
    ...
    $result .= $this->HeaderLine('X-Mailer', 'IOS Newsletter');
  ...
  public function HasMultiBytes($str) {
    if (function_exists('mb_strlen')) {
      return (strlen($str) > mb_strlen($str, $this->CharSet));
		...
		return (strlen($str) > eUTF::utf8_strlen($str));
    }
  }
  ...
  public function Base64EncodeWrapMB($str) {
    ...
    $mb_length = eUTF::utf8_strlen($str, $this->CharSet);
    ...
    for ($i = 0; $i < $mb_length; $i += $offset) {
      ...
      do {
        ...
        $chunk = eUTF::utf8_substr($str, $i, $offset, $this->CharSet);
