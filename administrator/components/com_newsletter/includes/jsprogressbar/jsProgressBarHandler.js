  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '/administrator/components/com_newsletter/includes/jsprogressbar/images/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/administrator/components/com_newsletter/includes/jsprogressbar/images/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
