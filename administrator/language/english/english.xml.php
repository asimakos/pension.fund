...
* @description: English Language for XML files
...
protected $AX_MENUIMGL = 'Menu Image';
protected $AX_MENUIMGD = 'A small image to be placed to the left or right of your menu item. Images must be in images/stories/ directory.';
protected $AX_MENUIMGONLYL = 'Use only the Menu Image';
protected $AX_MENUIMGONLYD = 'If you select <strong>Yes</strong> then the menu item will be represented ONLY by the image you have selected.<br /><br />If you select <strong>No</strong> then the menu item will be represented by the image you have selected PLUS the text.';
protected $AX_MENUIMG2D = 'A small image to be placed to the left or right of your menu item. Images must be in /images directory.';
...
protected $AX_BACKBUTL = 'Back Button';
protected $AX_BACKBUTD = 'Show/Hide a Back Button, that returns you to the previously view page.';
protected $AX_USEGLB = 'Use Global';
protected $AX_HIDE = 'Hide';
protected $AX_SHOW = 'Show';
protected $AX_AUTO = 'Auto';
protected $AX_PAGTITLSL = 'Show Page Title';
protected $AX_PAGTITLSD = 'Show/Hide the Page Title.';
protected $AX_PAGTITLL = 'Page Title';
protected $AX_PAGTITLD = 'Text to display at the top of the page. If left blank, the Menu name will be used instead.';
protected $AX_PAGTITL2D = 'Text to display at the top of the page.';
protected $AX_LEFT = 'Left';
protected $AX_RIGHT = 'Right';
protected $AX_PRNTICOL = 'Print Icon';
protected $AX_PRNTICOD = 'Show/Hide the item print button - only affects this page.';
protected $AX_YES = 'Yes';
protected $AX_NO = 'No';
protected $AX_SECNML = 'Section Name';
protected $AX_SECNMD = 'Show/Hide the Section the item belongs to.';
protected $AX_SECNMLL = 'Section Name Linkable';
protected $AX_SECNMLD = 'Make the Section text a link to the actual section page.';
protected $AX_CATNML = 'Category Name';
protected $AX_CATNMD = 'Show/Hide the Category the item belongs to.';
...
protected $AX_ITMRATD = 'Show/Hide the item rating - only affects this page.';
protected $AX_AUTNML = 'Author Names';
protected $AX_AUTNMD = 'Show/Hide the item author - only affects this page.';
protected $AX_CTDL = 'Created Date and Time';
protected $AX_CTDD = 'Show/Hide the item creation date - only affects this page.';
protected $AX_MTDL = 'Modified Date and Time';
protected $AX_MTDD = 'Show/Hide the item modification date - only affects this page.';
protected $AX_PDFICL = 'PDF Icon';
protected $AX_PDFICD = 'Show/Hide the item PDF button - only affects this page.';
protected $AX_PRICL = 'Print Icon';
protected $AX_PRICD = 'Show/Hide the item print button - only affects this page.';
protected $AX_EMICL = 'Email Icon';
protected $AX_EMICD = 'Show/Hide the item email button - only affects this page.';
protected $AX_FTITLE = 'Title';
protected $AX_FAUTH = 'Author';
protected $AX_FHITS = 'Hits';
protected $AX_DESCRL = 'Description';
protected $AX_DESCRD = 'Show/Hide the Description below.';
protected $AX_DESCRTXL = 'Description Text';
protected $AX_DESCRTXD = 'Description for page, if left blank it will load _WEBLINKS_DESC from your language file';
protected $AX_IMAGEL = 'Image';
protected $AX_IMGFRPD = 'Image for page, must be located in the /images/stories directory. By default it will load web_links.jpg. -Do not use an image- means that an image is not loaded.';
protected $AX_IMGALL = 'Image Align';
protected $AX_IMGALD = 'Alignment of the image.';
protected $AX_TBHEADL = 'Table Headings';
protected $AX_TBHEADD = 'Show/Hide the Table Headings.';
protected $AX_POSCOLL = 'Position Column';
protected $AX_POSCOLD = 'Show/Hide the Position column.';
protected $AX_EMAILCOLL = 'Email Column';
protected $AX_EMAILCOLD = 'Show/Hide the Email column.';
protected $AX_TELCOLL = 'Telephone Column';
protected $AX_TELCOLD = 'Show/Hide the Telephone column.';
protected $AX_FAXCOLL = 'Fax Column';
protected $AX_FAXCOLD = 'Show/Hide the Fax column.';
...
protected $AX_INTROD = 'Number of Items to be displayed with the introduction text shown.';
...
protected $AX_PAGD = 'Show/Hide Pagination support.';
protected $AX_PAGRL = 'Pagination Results';
protected $AX_PAGRD = 'Show/Hide Pagination Results info ( e.g 1-4 of 4 ).';
protected $AX_MOSIL = 'MOSImages';
protected $AX_MOSID = 'Display {mosimages}.';
protected $AX_ITMTL = 'Item Titles';
protected $AX_ITMTD = 'Show/Hide the items title.';
protected $AX_REMRL = 'Read More';
protected $AX_REMRD = 'Show/Hide the Read More link.';
protected $AX_OTHCATL = 'Other Categories';
protected $AX_OTHCATD = 'When viewing a Category, Show/Hide the list of other Categories.';
protected $AX_TDISTPD = 'Text to display at the top of the page.';
...
protected $AX_SHCDESD = 'Show/Hide the Category Description.';
protected $AX_DESCIL = 'Description Image';
protected $AX_MUDATFL = 'Date Format';
protected $AX_MUDATFD = "The format of the date displayed, using PHP strftime Command Format - if left blank it will load the format from your language file.";
protected $AX_MUDATCL = 'Date Column';
protected $AX_MUDATCD = 'Show or Hide the Date column.';
protected $AX_MUAUTCL = 'Author Column';
protected $AX_MUAUTCD = 'Show/Hide the Author column.';
protected $AX_MUHITCL = 'Hits Column';
protected $AX_MUHITCD = 'Show/Hide the Hits column.';
protected $AX_MUNAVBL = 'Navigation Bar';
protected $AX_MUNAVBD = 'Show/Hide the Navigation bar.';
protected $AX_MUORDSL = 'Order Select';
protected $AX_MUORDSD = 'Show/Hide the Order Select dropdown.';
protected $AX_MUDSPSL = 'Display Select';
protected $AX_MUDSPSD = 'Show/Hide the Display Select dropdown.';
...
protected $AX_MUFLTD = 'Show/Hide the Filter ability.';
protected $AX_MUFLTFL = 'Filter Field';
protected $AX_MUFLTFD = 'Which field shall the filter apply to.';
protected $AX_MUOCATL = 'Other Categories';
protected $AX_MUOCATD = 'Show/Hide the listing of other Categories.';
protected $AX_MUECATL = 'Empty Categories';
protected $AX_MUECATD = 'Show/Hide empty (no items) categories.';
protected $AX_CATDSCL = 'Category Description';
protected $AX_CATDSBLND = 'Show/Hide the Category Description, it will appear below the Category Name.';
protected $AX_NAMCOLL = 'Name Column';
protected $AX_LINKDSCL = 'Link Descriptions';
protected $AX_LINKDSCD = 'Show/Hide the Description text of the Links.';
//com_contact/contact.xml
protected $AX_CCT_CDESC = 'This component shows a listing of Contact Information.';
protected $AX_CCT_CATLISTSL = 'Category List - Section';
protected $AX_CCT_CATLISTSD = 'Show/Hide the List of Categories in List view page.';
protected $AX_CCT_CATLISTCL = 'Category List - Category';
protected $AX_CCT_CATLISTCD = 'Show/Hide the List of Categories in Table view page.';
protected $AX_CCT_CATDSCD = 'Show/Hide the Description for the list of other categories.';
protected $AX_CCT_NOCATITL = '# Category Items';
protected $AX_CCT_NOCATITD = 'Show/Hide the number of items in each category.';
//com_contact/contact_items.xml
protected $AX_CIT_CDESC = 'Parameters for individual Contact Items.';
protected $AX_CIT_NAMEL = 'Name';
protected $AX_CIT_NAMED = 'Show/Hide the name info.';
protected $AX_CIT_POSITL = 'Position';
protected $AX_CIT_POSITD = 'Show/Hide the position info.';
protected $AX_CIT_EMAILL = 'Email';
protected $AX_CIT_EMAILD = 'Show/Hide the email info. If you set it to show, the address will be protected from spambots by javascript cloaking.';
protected $AX_CIT_SADDREL = 'Street Address';
protected $AX_CIT_SADDRED = 'Show/Hide the street address info.';
protected $AX_CIT_TOWNL = 'Town/Suburb';
protected $AX_CIT_TOWND = 'Show/Hide the town/suburb info.';
protected $AX_CIT_STATEL = 'State';
protected $AX_CIT_STATED = 'Show/Hide the state info.';
protected $AX_CIT_COUNTRL = 'Country';
protected $AX_CIT_COUNTRD = 'Show/Hide the country info.';
protected $AX_CIT_ZIPL = 'Post/Zip Code';
protected $AX_CIT_ZIPD = 'Show/Hide the post code info.';
protected $AX_CIT_TELL = 'Telephone';
protected $AX_CIT_TELD = 'Show/Hide the telephone info.';
protected $AX_CIT_FAXL = 'Fax';
protected $AX_CIT_FAXD = 'Show/Hide the fax info.';
protected $AX_CIT_MISCL = 'Misc Info';
protected $AX_CIT_MISCD = 'Show/Hide the misc info.';
protected $AX_CIT_VCARDL = 'Vcard';
protected $AX_CIT_VCARDD = 'Show/Hide the Vcard.';
protected $AX_CIT_CIMGL = 'Image';
protected $AX_CIT_CIMGD = 'Show/Hide the image.';
protected $AX_CIT_DEMAILL = 'Email description';
protected $AX_CIT_DEMAILD = 'Show/Hide the Description Text below.';
protected $AX_CIT_DTXTL = 'Description text';
protected $AX_CIT_DTXTD = 'The Description text for the Email form. If left blank, it will use the _EMAIL_DESCRIPTION language definition.';
protected $AX_CIT_EMFRML = 'Email Form';
protected $AX_CIT_EMFRMD = 'Show/Hide the email to form.';
protected $AX_CIT_EMCPYL = 'Email Copy';
protected $AX_CIT_EMCPYD = 'Show/Hide the checkbox to email a copy to senders address.';
protected $AX_CIT_DDL = 'Drop Down';
protected $AX_CIT_DDD = 'Show/Hide the Drop Down select list in Contact view.';
...
protected $AX_CIT_EMICOND = 'Icon for the Email info.';
...
protected $AX_CCT_NAMED = 'Show/Hide the name info.';
protected $AX_CCT_POSITL = 'Position';
protected $AX_CCT_POSITD = 'Show/Hide the position info.';
protected $AX_CCT_EMAILL = 'Email';
protected $AX_CCT_EMAILD = 'Show/Hide the email info. If you set to show, the address will be protected from spambots by javascript cloaking.';
protected $AX_CCT_SADDREL = 'Street Address';
protected $AX_CCT_SADDRED = 'Show/Hide the street address info.';
protected $AX_CCT_TOWNL = 'Town/Suburb';
protected $AX_CCT_TOWND = 'Show/Hide the suburb info.';
protected $AX_CCT_STATEL = 'State';
protected $AX_CCT_STATED = 'Show/Hide the state info.';
protected $AX_CCT_COUNTRL = 'Country';
protected $AX_CCT_COUNTRD = 'Show/Hide the country info.';
protected $AX_CCT_ZIPL = 'Post/Zip Code';
protected $AX_CCT_ZIPD = 'Show/Hide the post code info.';
protected $AX_CCT_TELL = 'Telephone';
protected $AX_CCT_TELD = 'Show/Hide the telephone info.';
protected $AX_CCT_FAXL = 'Fax';
protected $AX_CCT_FAXD = 'Show/Hide the fax info.';
protected $AX_CCT_MISCL = 'Misc Info';
protected $AX_CCT_MISCD = 'Show/Hide the misc info.';
protected $AX_CCT_VCARDL = 'Vcard';
protected $AX_CCT_VCARDD = 'Show/Hide the Vcard.';
protected $AX_CCT_CIMGL = 'Image';
protected $AX_CCT_CIMGD = 'Show/Hide the image.';
protected $AX_CCT_DEMAILL = 'Email description';
protected $AX_CCT_DEMAILD = 'Show/Hide the Description Text below.';
protected $AX_CCT_DTXTL = 'Description text';
protected $AX_CCT_DTXTD = 'The Description text for the Email form. If left blank, it will use the _EMAIL_DESCRIPTION language definition.';
protected $AX_CCT_EMFRML = 'Email Form';
protected $AX_CCT_EMFRMD = 'Show/Hide the email to form.';
protected $AX_CCT_EMCPYL = 'Email Copy';
protected $AX_CCT_EMCPYD = 'Show/Hide the checkbox to email a copy to senders address.';
protected $AX_CCT_DDL = 'Drop Down';
protected $AX_CCT_DDD = 'Show/Hide the Drop Down select list in Contact view.';
...
protected $AX_CCT_EMICOND = 'Icon for the Email info.';
...
protected $AX_CNT_CDESC = 'This shows a single content page.';
protected $AX_CNT_INTEXTL = 'Intro Text';
protected $AX_CNT_INTEXTD = 'Show/Hide the intro text.';
...
protected $AX_FP_CDESC = 'This component shows all the published content items from your site marked Show on Frontpage.';
//com_login/login.xml
protected $AX_LG_CDESC = 'Parameters for individual Contact Items.';
protected $AX_LG_LPTL = 'Login Page Title';
protected $AX_LG_LPTD = 'Text to display at the top of the page. If left blank, the Menu name will be used instead.';
protected $AX_LG_LRURLL = 'Login Redirection URL';
protected $AX_LG_LRURLD = 'What page will the login redirect to after login. If left blank, will load front page.';
protected $AX_LG_LJSML = 'Login JS Message';
protected $AX_LG_LJSMD = 'Show/Hide the javascript pop-up, indicating Login Success.';
protected $AX_LG_LDESCL = 'Login Description';
protected $AX_LG_LDESCD = 'Show/Hide the Login Description below.';
protected $AX_LG_LDESTL = 'Login Description Text';
protected $AX_LG_LDESTD = 'Text to display on the login Page. If left blank, _LOGIN_DESCRIPTION will be used.';
protected $AX_LG_LIMGL = 'Login Image';
protected $AX_LG_LIMGD = 'Image for the Login Page.';
protected $AX_LG_LIMGAL = 'Login Image Align';
protected $AX_LG_LIMGAD = 'Alignment for Login Image.';
protected $AX_LG_LOPTL = 'Logout Page Title';
protected $AX_LG_LOPTD = 'Text to display at the top of the page. If left blank, the Menu name will be used instead.';
protected $AX_LG_LORURLL = 'Logout Redirection URL';
protected $AX_LG_LORURLD = 'What page will be redirected to after logout, if left blank, will load front page.';
protected $AX_LG_LOJSML = 'Logout JS Message';
protected $AX_LG_LOJSMD = 'Show/Hide the javascript pop-up indicating Logout Success.';
protected $AX_LG_LODSCL = 'Logout Description';
protected $AX_LG_LODSCD = 'Show/Hide the Logout Description below.';
protected $AX_LG_LODSTL = 'Logout Description Text';
protected $AX_LG_LODSTD = 'Text to display on the logout Page. If left blank, _LOGOUT_DESCRIPTION will be used.';
protected $AX_LG_LOGOIL = 'Logout Image';
protected $AX_LG_LOGOID = 'Image for the Logout Page.';
protected $AX_LG_LOGOIAL = 'Logout Image Align';
protected $AX_LG_LOGOIAD = 'Alignment for Logout Image.';
//com_massmail/massmail.xml
protected $AX_MM_CDESC = 'This component allows you to send a mass email to certain user groups.';
//com_media/media.xml
...
protected $AX_MUCIL_CNAME = 'Link to Component Item';
...
protected $AX_MUCCT_CNAME = 'Contact Category (table view)';
protected $AX_MUCCT_CDESC = 'Shows a Table view of Contact items for a particular Category.';
protected $AX_MUCCT_CATDL = 'Category Description';
protected $AX_MUCCT_CATDD = 'Show/Hide the Description for the list of other categories.';
//com_menus/contact_item_link/contact_item_link.xml
protected $AX_MUCTIL_CNAME = 'Link to Contact Item';
...
protected $AX_MUCAC_CNAME = 'Content Category Archive (blog view)';
protected $AX_MUCAC_CDESC = 'Shows a listing of Content items archived for a particular category.';
//com_menus/content_archive_section/content_archive_section.xml
protected $AX_MUCAS_CNAME = 'Content Section Archive (blog view)';
protected $AX_MUCAS_CDESC = 'Shows a listing of Content items archived for a particular section.';
//com_menus/content_blog_category/content_blog_category.xml
protected $AX_MUCBC_CNAME = 'Content Category (blog view)';
protected $AX_MUCBC_CDESC = 'Displays a page of content items from multiple categories using a blog format.';
//com_menus/content_blog_section/content_blog_section.xml
protected $AX_MUCBS_CNAME = 'Content Section (blog view)';
protected $AX_MUCBS_CDESC = 'Displays a page of content items from multiple sections using a blog format.';
protected $AX_MUCBS_SHSD = 'Show/Hide the Section Description.';
//com_menus/content_category/content_category.xml
protected $AX_MUCC_CNAME = 'Content Category (table view)';
protected $AX_MUCC_CDESC = 'Shows a Table view of Content items for a particular Category.';
protected $AX_MUCC_SHLOCD = 'Show/Hide the listing of other Categories.';
//com_menus/content_item_link/content_item_link.xml
protected $AX_MCIL_CNAME = 'Link to Content Item';
...
protected $AX_MCS_CNAME = 'Content Section (table view)';
protected $AX_MCS_CDESC = 'Creates a listing of Content categories for a particular section.';
protected $AX_MCS_STL = 'Section Title';
protected $AX_MCS_STD = 'Show/hide the section title.';
protected $AX_MCS_SHCTID = 'Show/Hide the Category Description Image.';
//com_menus/content_typed/content_typed.xml
protected $AX_MLSC_CNAME = 'Link to Autonomous Page';
...
protected $AX_MNSFC_CNAME = 'Newsfeed Category (table view)';
protected $AX_MNSFC_CDESC = 'Shows a Table view of Newsfeed items for a particular Category.';
protected $AX_MNSFC_SHNCD = 'Show/Hide the Name column.';
protected $AX_MNSFC_ACL = 'Articles Column';
protected $AX_MNSFC_ACD = 'Show/Hide the Articles column.';
protected $AX_MNSFC_LCL = 'Link Column';
protected $AX_MNSFC_LCD = 'Show/Hide the Link column.';
//com_menus/newsfeed_link/newsfeed_link.xml
protected $AX_MNSFL_CNAME = 'Link to Newsfeed';
protected $AX_MNSFL_CDESC = 'Creates a link to a single published Newsfeed.';
protected $AX_MNSFL_FDIML = 'Feed Image';
protected $AX_MNSFL_FDIMD = 'Show/Hide the image of the feed.';
protected $AX_MNSFL_FDDSL = 'Feed Description';
protected $AX_MNSFL_FDDSD = 'Show/Hide the description text of the feed.';
protected $AX_MNSFL_WDCL = 'Word Count';
protected $AX_MNSFL_WDCD = 'Allows you to limit the amount of visible item description text. 0 will show all the text.';
...
protected $AX_MWLC_CNAME = 'Weblink Category (table view)';
protected $AX_MWLC_CDESC = 'Shows a Table view of Weblink items for a particular Weblink Category.';
...
protected $AX_MWRP_SCRBD = 'Show/Hide Horizontal & Vertical scroll bars.';
...
protected $AX_NFE_SHFNCD = 'Show/Hide the Feed Name column.';
protected $AX_NFE_NOACL = '# Articles Column';
protected $AX_NFE_NOACD = 'Show/Hide the # of articles in the feed.';
protected $AX_NFE_LCL = 'Link Column';
protected $AX_NFE_LCD = 'Show/Hide the Feed Link column.';
protected $AX_NFE_IDL = 'Item Description';
protected $AX_NFE_IDD = 'Show/Hide the description or intro text of an item.';
...
protected $AX_SYN_IMGD = 'Image to be included in feed.';
protected $AX_SYN_IMGAL = 'Image Alt';
protected $AX_SYN_IMGAD = 'Alt text for image.';
...
protected $AX_SYN_TLEND = 'The word length of the article text - 0 will show no text.';
...
protected $AX_TDC_CDESC = 'This shows a single content page.';
//com_weblinks/weblinks.xml
protected $AX_WBL_CDESC = 'This component shows a listing of Weblinks with site screenshots.';
protected $AX_WBL_LDL = 'Link Descriptions';
protected $AX_WBL_LDD = 'Show/Hide the Description text of the Links.';
protected $AX_WBL_ICL = 'Icon';
protected $AX_WBL_ICD = 'Icon to be used to the left of the url links in Table view.';
protected $AX_WBL_SCSL = 'Screenshots';
protected $AX_WBL_SCSD = 'Show linked site screenshot. If used, then the above Weblinks Icon will not be displayed.';
...
protected $AX_AM_LN_DESC = 'This module shows a list of the most recently published Items that are still current (some may have expired even though they are the most recent). Items that are displayed on the Front Page component are not included in the list.'; 
//administrator/modules/mod_logged.xml
protected $AX_AM_LG_DESC = 'This module shows a list of the currently logged in users.'; 
//administrator/modules/mod_popular.xml
protected $AX_AM_PI_DESC = 'This module shows a list of the popular published Items that are still current (some may have expired even though they are the most recent). Items that are displayed on the Front Page component are not included in the list.'; 
//administrator/modules/mod_stats.xml
protected $AX_AM_ST_DESC = 'This module shows stats of Items that are still current (some may have expired even though they are the most popular). Items that are displayed on the Front Page component are not included in the list.'; 
//SITE MODULES
//General
...
protected $AX_SM_SMIL = 'Show Menu Icons'; 
protected $AX_SM_SMID = 'Show the Menu Icons you have selected for your menu items.'; 
...
protected $AX_SM_CU_FEDD = 'Show the description text for the whole Feed.'; 
protected $AX_SM_CU_FEIL = 'Feed Image'; 
protected $AX_SM_CU_FEDID = 'Show the image associated with the whole Feed.'; 
...
protected $AX_SM_CU_ITDD = 'Show the description or intro text of individual news items.'; 
protected $AX_SM_CU_WCL = 'Word Count'; 
protected $AX_SM_CU_WCD = 'Allows you to limit the amount of visible item description text. 0 will show all the text.'; 
//modules/mod_archive.xml
protected $AX_SM_AR_DESC = 'This module shows a list of the calendar months, which contain Archived items. After you have changed the status of a Content Item to \'Archived\' this list will be automatically generated.'; 
protected $AX_SM_AR_CNTL = 'Count'; 
protected $AX_SM_AR_CNTD = 'The number of items to display (default is 10).'; 
//modules/mod_banners.xml
protected $AX_SM_BN_DESC = 'The banner module allows to show the active banners out of the component within your site.'; 
protected $AX_SM_BN_CNTL = 'Banner client'; 
protected $AX_SM_BN_CNTD = "Reference to banner client id. Enter separated by ','!"; 
protected $AX_SM_BN_NBSL = 'Number of Banners Shown';
...
protected $AX_SM_BN_UNQBD = 'No banner is ever shown more than once (per session). If all banners have been shown, then history is cleared and restarted.';
//modules/mod_latestnews.xml
protected $AX_SM_LN_DESC = 'This module shows a list of the most recently published Items that are still current (some may have expired even though they are the most recent). Items that are displayed on the Front Page component are not included in the list.'; 
protected $AX_SM_LN_FPIL = 'Frontpage Items'; 
protected $AX_SM_LN_FPID = 'Show/Hide items designated for the Frontpage - only works when in Content Items only mode.'; 
protected $AX_SM_AR_CNT5D = 'The number of items to display (default is 5).'; 
protected $AX_SM_LN_CATIL = 'Category ID'; 
protected $AX_SM_LN_CATID = 'Selects items from a specific Category or set of Categories (to specify more than one Category, separate with a comma , ).'; 
protected $AX_SM_LN_SECIL = 'Section ID'; 
protected $AX_SM_LN_SECID = 'Selects items from a specific Section or set of Sections (to specify more than one Section, separate with a comma , ).'; 
//modules/mod_login.xml
protected $AX_SM_LF_DESC = 'This module displays a Username and Password login form. It also displays a link to retrieve a forgotten password. If user registration is enabled, (refer to the Configuration settings), then another link will be shown to invite users to self-register.'; 
...
protected $AX_SM_LF_LRUD = 'What page will the login redirect to after login. If left blank will load front page.'; 
protected $AX_SM_LF_LORUL = 'Logout Redirection URL'; 
protected $AX_SM_LF_LORUD = 'What page will the login redirect to after logout. If left blank will load front page.'; 
protected $AX_SM_LF_LML = 'Login Message'; 
protected $AX_SM_LF_LMD = 'Show/Hide the javascript pop-up indicating Login Success.'; 
protected $AX_SM_LF_LOML = 'Logout Message'; 
protected $AX_SM_LF_LOMD = 'Show/Hide the javascript pop-up indicating Logout Success.'; 
protected $AX_SM_LF_GML = 'Greeting'; 
protected $AX_SM_LF_GMD = 'Show/Hide the simple greeting text.'; 
...
protected $AX_SM_MNM_IIL = 'Indent Image'; 
protected $AX_SM_MNM_IID = 'Choose which indent image system to utilize.'; 
protected $AX_SM_MNM_OP4 = 'Template'; 
protected $AX_SM_MNM_OP5 = 'Elxis default images'; 
protected $AX_SM_MNM_OP6 = 'Use params below'; 
protected $AX_SM_MNM_OP7 = 'None'; 
protected $AX_SM_MNM_II1L = 'Indent Image 1'; 
protected $AX_SM_MNM_II1D = 'Image for the first sub-level.'; 
protected $AX_SM_MNM_II2L = 'Indent Image 2'; 
protected $AX_SM_MNM_II2D = 'Image for the second sub-level.'; 
protected $AX_SM_MNM_II3L = 'Indent Image 3'; 
protected $AX_SM_MNM_II3D = 'Image for the third sub-level.'; 
protected $AX_SM_MNM_II4L = 'Indent Image 4'; 
protected $AX_SM_MNM_II4D = 'Image for the fourth sub-level.'; 
protected $AX_SM_MNM_II5L = 'Indent Image 5'; 
protected $AX_SM_MNM_II5D = 'Image for the fifth sub-level.'; 
protected $AX_SM_MNM_II6L = 'Indent Image 6'; 
protected $AX_SM_MNM_II6D = 'Image for the sixth sub-level.'; 
...
protected $AX_SM_MRC_DESC = 'This module shows a list of the currently published Items that have been viewed the most - determined by the number of times the page has been viewed.'; 
...
protected $AX_SM_MRC_FPID = 'Show/Hide items designated for the Frontpage - only works when in Content Items only mode.'; 
...
protected $AX_SM_MRC_CIDD = 'Selects items from a specific Category or set of Categories (to specify more than one Category, seperate with a comma , ).'; 
protected $AX_SM_MRC_SIDL = 'Section ID'; 
protected $AX_SM_MRC_SIDD = 'Selects items from a specific Section or set of Sections (to specify more than one Section, seperate with a comma , ).'; 
...
protected $AX_SM_NWF_SIL = 'Show images'; 
protected $AX_SM_NWF_SID = 'Display content item images.'; 
...
protected $AX_SM_NWF_RMD = 'Show/Hide the Read More button.'; 
protected $AX_SM_NWF_ITL = 'Item Title'; 
protected $AX_SM_NWF_ITD = 'Show item title.'; 
...
protected $AX_SM_RNI_DESC = 'This module display a random image from the chosen directory.'; 
protected $AX_SM_RNI_ITL = 'Image Type'; 
protected $AX_SM_RNI_ITD = 'Type of image PNG/GIF/JPG etc. (default is JPG).'; 
protected $AX_SM_RNI_IFL = 'Image Folder'; 
protected $AX_SM_RNI_IFD = 'Path to the image folder relative to the site URL, eg: images/stories.'; 
protected $AX_SM_RNI_LNL = 'Link'; 
protected $AX_SM_RNI_LND = 'A URL to redirect to if image is clicked, eg: http://www.goup.gr'; 
protected $AX_SM_RNI_WL = 'Width (px)'; 
protected $AX_SM_RNI_WD = 'Image width (forces all images to be displayed with this width).'; 
protected $AX_SM_RNI_HL = 'Height (px)'; 
protected $AX_SM_RNI_HD = 'Image height (forces all images to be displayed with this height).'; 
...
protected $AX_SM_RSS_091D = 'Show/Hide RSS 0.91 Link.'; 
protected $AX_SM_RSS_10D = 'Show/Hide RSS 1.0 Link.'; 
protected $AX_SM_RSS_20D = 'Show/Hide RSS 2.0 Link.'; 
protected $AX_SM_RSS_03D = 'Show/Hide Atom 0.3 Link.'; 
protected $AX_SM_RSS_OPD = 'Show/Hide OPML Link.'; 
protected $AX_SM_RSS_I091L = 'RSS 0.91 Image'; 
protected $AX_SM_RSS_I10L = 'RSS 1.0 Image'; 
protected $AX_SM_RSS_I20L = 'RSS 2.0 Image'; 
protected $AX_SM_RSS_I03L = 'Atom Image'; 
protected $AX_SM_RSS_IOPL = 'OPML Image'; 
protected $AX_SM_RSS_CHID = 'Choose the image to be used.'; 
//modules/mod_search.xml
protected $AX_SM_SEM_DESC = 'This module will display a search box.';
protected $AX_SM_SEM_TOP = 'Top';
protected $AX_SM_SEM_BTM = 'Bottom';
protected $AX_SM_SEM_BWL = 'Box Width';
protected $AX_SM_SEM_BWD = 'Size of the search text box.';
protected $AX_SM_SEM_TXL = 'Text';
protected $AX_SM_SEM_TXD = 'The text that appears in the search text box, if left blank it will load _SEARCH_BOX from your language file.';
...
protected $AX_SM_SEM_BTXD = 'The text that appears in the search button, if left blank it will load _SEARCH_TITLE from your language file.'; 
//modules/mod_sections.xml
protected $AX_SM_SEC_DESC = 'The Section module shows a list of all Sections configured in your database. The Sections refer here to the Item Sections only. If the configuration \'Show Unauthorized Links\' is not set, the list will be limited to the sections the user is allowed to see.'; 
protected $AX_SM_SEC_CL = 'Count';
protected $AX_SM_SEC_CD = 'The number of items to display (default is 5).';
//modules/mod_stats.xml
protected $AX_SM_STA_DESC = 'The Statistics module shows information about your server installation and statistics, number of contents in your database, and number of web links you provide.';
...
protected $AX_SM_TMC_SPL = 'Show Preview'; 
protected $AX_SM_TMC_SPD = 'Template preview is to be shown.'; 
protected $AX_SM_TMC_WL = 'Width'; 
protected $AX_SM_TMC_WD = 'This is the width of the preview image (default 140 px).'; 
protected $AX_SM_TMC_HL = 'Height'; 
protected $AX_SM_TMC_HD = 'This is the height of the preview image (default 90 px).'; 
...
protected $AX_SM_WSO_DD = 'Select what shall be shown.'; 
...
protected $AX_SM_WRM_DESC = 'This module shows an IFrame window to specified location.'; 
...
protected $AX_SM_WRM_SCBD = 'Show/Hide Horizontal & Vertical scroll bars.'; 
...
protected $AX_ED_IBROWSERD = 'iBrowser is an advanced image manager';
...
protected $AX_ED_PLIMGPLUGIND = 'Enables the Advanced Image Manager. By default the Simple Image Editor is enabled.';
...
protected $AX_ED_PLPREVD = 'This plugin adds a preview button to TinyMCE, pressing the button opens a popup showing the current content.';
protected $AX_ED_PLZOOML = 'Zoom Plugin';
protected $AX_ED_PLZOOMD = 'Adds a zoom drop list in MSIE5.5+, this plugin was mostly created to show how to add custom droplists as plugins.';
...
protected $AX_ED_PLDIRD = 'This plugin adds directionality icons to TinyMCE that enables TinyMCE to better handle languages that is written from right to left.';
...
protected $AX_TCLEANCACHE_D = 'Cleans cache directory from cached content items and images';
...
protected $AX_RTFICD = 'Show/Hide the RTF button - only affects this page.';
//modules/mod_whosonline.xml
...
protected $AX_SECTIONSD = 'Section IDs comma separated (,)';
protected $AX_CATEGORIES = 'Categories';
protected $AX_CATEGORIESD = 'Categories IDs comma separated (,)';
protected $AX_NUMDAYS = 'Number of days';
protected $AX_NUMDAYSD = 'Show items created in the last X days (default value 900)';
protected $AX_SHOWTHUMBS = 'Show thumbnails';
protected $AX_SHOWTHUMBSD = 'Show/Hide thumbnail image in intro text';
protected $AX_THUMBWIDTHD = 'Width of the thumbnail image in pixels';
protected $AX_THUMBHEIGHTD = 'Height of the thumbnail image in pixels';
protected $AX_KEEPRATIO = 'Keep ratio';
protected $AX_KEEPRATIOD = 'Preserve image aspect ratio. If Yes, then the height parameter above does n\'t matter.';
