...
class prefLang_russian {
	...
	public $_DATE = 'Дата';
	public $_E_SUBCONWAIT = 'Добавленные статьи, ждущие одобрения:';
	...
	Если вы не желаете получать уведомления об данных действиях, установите параметр USERS_RPASSMAIL в SoftDisk в значение Нет.";
...
На это письмо не надо отвечать, так как оно создано автоматически и предназначено только для уведомления.";
	...
	public $_E_NEWCOMBYTITLE = "Был оставлен новый комментарий %s к статье %s";
	public $_E_COMSTAYUNPUB = 'Этот комментарий останется неопубликованным, пока один из администраторов не опубликует его.';
	public $_E_ACCEXPDATE = 'Дата окончания действия аккаунта';
